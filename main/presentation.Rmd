...
color_vector_motor <- c("red", "blue3", "orange", "darkgrey")
```
...
preis_europaeisch <- data %>% 
  ...
  ggplot(aes(x = Marke, y = Grundpreis, fill = Marke)) +
  geom_col() + 
...
laufendeKosten_motorart <- df_long_Fix %>% 
  ...
  scale_fill_manual(values = c("#00CCFF", "#CC66CC", "#336600"))
...
- konkrete x-Stellen zum Berechnen auswählen

- Datenpunkte im Bereich um x-Stellen anschauen

- Gewichte für Datenpunkte berechnen

- y-Werte für die x-Stellen aus Datenpunkte und Gewichten berechnen

- Nicht-lineare Funktion approxmieren
